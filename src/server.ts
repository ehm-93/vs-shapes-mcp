...
import { cloneJsonValue, vsnum } from './vs/json.js';
...
function plainToJsonValue(v: unknown, where: string): JsonValue {
...
// ---------------------------------------------------------------------------
// RFC-6902 JSON Patch over the live lossless tree
// ---------------------------------------------------------------------------
...
function getAt(root: JsonValue, ptr: string, what: string): JsonValue {
  let cur = root;
...
function applyPatch(root: JsonValue, patch: PatchOpInput[]): void {
